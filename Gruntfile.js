module.exports = function(grunt) {
    ...
    let gruntConfig = {
        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    'assets/themes/GlobalStage/js/clients.min.js': ['assets/themes/GlobalStage/js/clients.js'],
                    'assets/themes/GlobalStage/js/global.min.js': ['assets/themes/GlobalStage/js/global.js'],
        ...
        cssmin: {
            target: {
                files: [{
                        src: ['assets/themes/GlobalStage/css/style.css'],
                        dest: 'assets/themes/GlobalStage/css/style.min.css',
                        ext: '.min.css'
                    },
                    {
        ...
        postcss: {
            ...
            dist: {
                src: [
                    'assets/css/*.css',
                    '!assets/css/*.min.css',
                    'assets/themes/GlobalStage/css/*.css',
                    '!assets/themes/GlobalStage/css/*.min.css',
                ]
            }
        },
        concat: {
        ...
        header: {
            dist: {
                ...
                files: {
                    ...
                    'assets/themes/GlobalStage/js/clients.min.js': 'assets/themes/GlobalStage/js/clients.min.js',
                    'assets/themes/GlobalStage/js/global.min.js': 'assets/themes/GlobalStage/js/global.min.js',
                }
            }
        },
    }
